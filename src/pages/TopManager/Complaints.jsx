...
return( 
      ...
      <div className=" flex-col  w-full bg-white md:w-full ">
       ...
       <div className="rounded-none space-y-2  shadow-lg shadow-indigo-500/40  bg-calm-blue  w-3/5  h-21 font-poppins flex flex-col  justify-between  items-center ml-5 mt-5 px-3 md:flex-row md:rounded-full">
         <img
