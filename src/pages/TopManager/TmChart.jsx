  ...
  return (
    ...
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 20 }}>
        ...
        <YAxis label={{ value: "No Request", angle: -90, position: "insideLeft", offset: -10 }} />
        <Tooltip />
        <Legend />
        <Bar dataKey="pv" name="Accept" fill="#8884d8" />
        <Bar dataKey="uv" name="Reject" fill="#eb4034" />
      </BarChart>
    </ResponsiveContainer>
    </Card>
    </>
