   ...
   const  showTaskMangers   = (props) =>  {
        ...
        return (
            <div className="flex flex-col md:flex-row  ">
                {/* Sidebar */}
                <div className= "bg-black h-screen md:w-1/5">

                    <TopManagerSidebar />
                </div>

                <div className="bg-blue-300 w-full md:w-4/5 flex-col h-screen">
                    {/* Navigation Bar */}
                    <NavbarWithoutSidebar name = "Kavisha Abeynayaka" userRole = "Top Manager"/>
