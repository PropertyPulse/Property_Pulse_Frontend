...
const AddTaskSupervisors = () => {
    ...
    const handleAddUser = async (e) => {
        ...
        try {
            const response = await axiosPrivate.post("/api/v1/admin/addTaskSupervisor", userData, {});
    ...
    const inputs = [
        ...
        },
        {
            ...
            pattern: "^[A-Za-z]+$",
            required: true,
            styles: 'w-1/3 flex-auto border-0'
        },
        {
            id: 4,
            name: 'address',
        ...
        <div className='w-full'>
            <div className='w-full px-24 py-9'>
                ...
                <div className='w-full space-x-0.5 pb-6 text-white flex'>
                    ...
                    <Link to='/system-admin/add-users/task-supervisor' className='w-1/4 px-8 py-2 bg-primary-blue-500 flex justify-center text-md font-medium rounded-none'>
                        Task Supervisor
                    </Link>
...
export default AddTaskSupervisors;