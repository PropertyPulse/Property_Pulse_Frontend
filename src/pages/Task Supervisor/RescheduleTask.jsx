                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    {RequestDetails.map((request, index) => (
                        <tr>
                            ...
                            <td className="px-6 py-4">
                                <input placeholder="Enter estimated number of days" className="px-1 py-1 rounded-lg border-2 border-gray-400" defaultValue={request.StartDate}/>
                            </td>
                            <td className="px-6 py-4">
                                <input placeholder="Enter estimated number of days" className="px-1 py-1 rounded-lg border-2 border-gray-400" defaultValue={request.EndDate}/>
                            </td>
                            <td className="px-6 py-4">
