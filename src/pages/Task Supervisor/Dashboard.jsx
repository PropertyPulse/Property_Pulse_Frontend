...
const Dashboard = () => {
  return (
          ...
          //     </div>
          // </section>
      <section className='dashboard w-full px-24 py-6'>
        <div className='w-full flex'>
          ...
          <div className='right w-1/2 h-full'>
            <div className="right-all w-full h-full items-center flex justify-center px-5 py-2">
              <div className='calender-div card bg-white h-full'>
                <h3 className='justify-center flex sub-title pb-3'>Monthly Schedule</h3>
                <Calender />
              </div>
            </div>
          </div>
        ...
        <div className='w-full'>
          <div className='bottom h-1/2 w-full'>
            <div className='bottom w-full h-full px-5 py-4'>
              <div className="bottom-inner h-full card bg-white">
                <h3 className='justify-center flex sub-title pb-1'>Task Analysis</h3>
                <Chart />
              </div>
            </div>
          </div>
