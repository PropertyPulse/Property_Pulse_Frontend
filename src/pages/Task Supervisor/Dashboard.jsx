...
const Dashboard = () => {
  return (
          ...
          //     </div>
          // </section>
      <section className='dashboard h-[calc(100vh-6rem)] w-full px-24 py-6 flex'>
        <div className='left h-full w-1/2'>
          <div className='left-top w-full h-1/2'>
            <div className='top-left h-full w-full px-5 py-4'>
              {/* Google Maps iframe */}
              <div className='map-div h-full card bg-white'>
                <h3 className='justify-center flex sub-title pb-3' >Current Location</h3>
          ...
          <div className='left-bottom h-1/2 w-full'>
            <div className='bottom-left w-full h-full px-5 py-4'>
              <div className="bottom-inner h-full card bg-white">
                <h3 className='justify-center flex sub-title pb-1'>Analytics</h3>
                <Chart />
              </div>
            </div>
          </div>
        ...
        <div className='right w-1/2 h-full'>
          <div className="right-all w-full h-full items-center flex justify-center px-5 py-4">
            <div className='calender-div card bg-white h-full'>
              <h3 className='justify-center flex sub-title pb-6'>Month Schedule</h3>
              <Calender />
            </div>
          </div>
        </div>
