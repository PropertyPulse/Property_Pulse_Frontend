        ...
        <div className='w-full h-[100vh] bg-background-blue flex'>
            ...
            <div className='w-full'>
                ...
                <section className='dashboard-po h-[calc(100vh-4.5rem)] w-full flex overflow-auto z-10'>
                    ...
                    <div className='w-2/4 min-w-[300px] min-h-full h-fit bg-[#EDF2FB] py-2 px-5'>
                        <div>
                            <button className='w-full px-5 py-3 bg-primary-blue-800 text-white rounded-md mb-5 hover:bg-primary-blue-800/80'>Make Complaint</button>
                        </div>
                        <div className="monthly-reports w-full min-h-[280px] bg-white p-5 mb-5 rounded-md shadow-xl border border-[#EDF2FB]">
                            <div className='w-full flex justify-between'>
