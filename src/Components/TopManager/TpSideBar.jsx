  ...
  const SidebarItems = [
    {
      title: 'Dashboard',
      icon: dashboardIcon,
      url: '/tm/dashboard', // Example URL, replace with actual URLs
    },
    {
      title: 'Property Request',
      icon: propertiesIcon,
      url: '/tm/new-property', // Example URL, replace with actual URLs
    },
    {
      title: 'Valuation Reports',
      icon: tasksIcon,
      url: '/tm/valuation-reports', // Example URL, replace with actual URLs
    },
    {
      title: 'Manage Task Supervisor',
      icon: taskApprovalsIcon,
      url: '/tm/manage-task-supervisor', // Example URL, replace with actual URLs
    },
    {
        title: 'Complaint',
        icon: taskApprovalsIcon,
        url: '/tm/complain', // Example URL, replace with actual URLs
      },
  ];
