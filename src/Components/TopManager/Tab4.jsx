...
function Tab1(props) {
    return (
        <div
            ...
            <div
                className="border-b-2 border-success px-6 py-3 text-neutral-600 dark:border-success-300 dark:text-neutral-50">
                Header
            </div>
            <div className="p-6">
                <h5
            ...
            <div
                className="border-t-2 border-success px-6 py-3 text-neutral-600 dark:border-success-300 dark:text-neutral-50">
                Footer
            </div>
        </div>
    );
