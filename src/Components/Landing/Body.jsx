  ...
  return (
    <section id="home" className="h-screen p-20 bg-primary-blue-800">
      ...
      <div className="container flex flex-col-reverse px-6 mx-auto space-y-0 md:space-y-0 md:flex-row">
        {/* Left Item */}
        <div className="flex flex-col space-y-12 md:pl-14 mb-35 md:w-2/3">
          <h1 className="max-w-2xl text-3xl font-bold text-center text-lannding-text-white md:text-5xl md:text-left sm:text-center">
