...
const NewTaskRequestTable = ({ searchTerm }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axiosPrivate.get(
        "/api/v1/task-requests/getAllnewtaskrequests",
        {},
        {}
      );
  ...
  const fetchAvailableEmployees = async () => {
    try {
      const response = await axiosPrivate.get(
        "/api/v1/mpc/getallavailableemployees"
                ...
                >
                  ...
                  <div className="flex gap-1">
                      ...
                      <Modal.Body>
                        <div className="">
                          <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                            Assign the Task to the Team leader.
                          </p>
                    ...
                    <Modal
                      ...
                      onClose={() => props.setOpenModal(undefined)}
                    >
                      <Modal.Header>Reshedule </Modal.Header>
                      <Modal.Body>
                        <div className="">
                          <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                          If you cannot do the task in the sheduled data.Please Request a Reshedule date.Task supervisor will accept the Request.Accepted request will show in the request section in the dashboard.
                          </p>
                          <div className="mb-2 block mt-4">
                            <Label htmlFor="comment" value="Your Feedback" />
                          </div>
...
//   const [selectedEmployeeId, setSelectedEmployeeId] = useState("");
//
//   const handleOpenModal = (type, requestId) => {
//     setModalPlacement("placement");
//     setOpenModal({ type, requestId });
//   };
//
//
//
...
//             <Table.HeadCell>Property Id</Table.HeadCell>
//             <Table.HeadCell>Location</Table.HeadCell>
//             <Table.HeadCell>reqid</Table.HeadCell>
//             <Table.HeadCell>Task</Table.HeadCell>
//             <Table.HeadCell>Estimated Price</Table.HeadCell>
//             <Table.HeadCell>Schedule Date</Table.HeadCell>
//             <Table.HeadCell>More info</Table.HeadCell>
...
//                       onClick={() => {
//                         setOpenModal("placement");
//                         setPropertyId(rowData.id); // Set the propertyId in the state
//                       }}
//                   >
//                     Accept
//                   </Button>
...
//                     position={props.modalPlacement}
//                     size="md"
//                     onClose={() => setOpenModal({ type: undefined, requestId: null })}
//                   >
//                     <Modal.Header>Feedback </Modal.Header>
//                     <Modal.Body>
//                       <div className="">
...
//                     <Modal.Footer>
//                       <Button
//                           onClick={() => handleAccept(openModal.requestId)} // Use the stored ID here
//                           className="bg-secondary-gray hover:bg-secondary-gray-light"
//                       >
//                         Accept
//                       </Button>
