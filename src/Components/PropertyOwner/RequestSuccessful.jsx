    ...
    return (
        <div>
            ...
            <img src={SuccessImg} alt='Register Success Image' className='h-48 w-48 mx-auto shadow-md rounded-full' />
                <h1 className='text-4xl text-[#0e2954] font-bold mt-10 text-center'>Request Sent Successfully</h1>
                <div className='w-full flex justify-center items-center mt-20'>
                    <NavLink to='property-owner/schedule-tasks' className='w-40 text-center bg-black text-white p-3 text-sm'>Login</NavLink>
                </div>                
            </div>
        </div>
    )
