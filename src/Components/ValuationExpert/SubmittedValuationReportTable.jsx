...
const SubmittedValuationReportTable = ({ searchTerm }) => {
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <Table striped>
          <Table.Head>
            ...
            <Table.HeadCell>Submited Date</Table.HeadCell>
            <Table.HeadCell>View Report</Table.HeadCell>
          </Table.Head>
              ...
              paginatedData.map((item, index) => (
                ...
                >
                  ...
                  <Table.Cell>
                    <Button
                      onClick={() => {
                        setOpenModal("view"); // Set the propertyId in the state
                      }}
                    >
                      View Report
                    </Button>
...
export default SubmittedValuationReportTable;
