...
const InsuranceSidebar = () => {
  ...
  const SidebarItems = [
    {
      title: 'Quatations Request',
      icon: dashboardIcon,
      url: '/ins/quatation-request', // Example URL, replace with actual URLs
    },
    {
      title: 'Ongoing Quatation',
      icon: propertiesIcon,
      url: '/ins/ongoin-quatation', // Example URL, replace with actual URLs
    },
    {
      title: 'Insurance Request',
      icon: tasksIcon,
      url: '/ins/insurance-request', // Example URL, replace with actual URLs
    },
  ];
